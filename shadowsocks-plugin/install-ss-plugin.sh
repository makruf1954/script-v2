...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/makruf1954/script-v2/main/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
#wget -O shadowhost "https://raw.githubusercontent.com/makruf1954/script-v2/main/shadowsocks-plugin/shadowhost.sh"
#chmod +x shadowhost && shadowhost
wget -O delss "https://raw.githubusercontent.com/makruf1954/script-v2/main/shadowsocks/delss.sh"
cd
